...
../process/dsstatgroupby 'I/O' basic '1000*(return_to_driver - leave_driver)' group by 'device_number' basic 'bytes/1024' group by 'machine_id' basic bytes quantile disk_offset basic bytes group by buffertype from $1/check-data/h03126.ds-littleend >test.dsstatgroupby-tmp
