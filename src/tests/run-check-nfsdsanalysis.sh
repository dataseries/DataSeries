...
if [ `whoami` = anderse -a -f ../analysis/nfs/set-5/subset.500k.ds ]; then
    ../analysis/nfs/nfsdsanalysis -c 2,no_print_base,no_print_cube,test,incremental=1 ../analysis/nfs/set-5/subset.500k.ds | perl $SRC/check-data/clean-timing.pl >subset.500k.out
