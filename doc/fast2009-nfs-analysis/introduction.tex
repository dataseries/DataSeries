...
\fix{13. More motivation on why we do tracing}
\fix{17. rename datasets from nfs-1/nfs-2 to animation-2003, animation-2007}
...
\fix{2. add picture of the overall process to make it clear which
tools are used where}
