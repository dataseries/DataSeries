...
Figure~\ref{fig:bwrolling-mbps}(b) shows nfs-2/set-5 at different
...
% \caption{Tail of the quantiles in Mbps and kpps for the nfs-2 traces.}
...
This result led us to further analyze the data as it seemed surprising
...
deeper at the operation that preceeded a skip in the sequence, we
...
\caption{Negligable effect of reordering I/Os to improve estimated sequentiality.}
