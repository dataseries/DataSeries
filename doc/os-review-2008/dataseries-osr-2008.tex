...
Eric Anderson, Martin Arlitt, Charles B. Morrey III, Alistair Veitch  \\
 \affaddr{HP Labs, 1501 Page Mill Road,  Palo Alto, CA} \\
...
\keywords{data format, trace-analysis, compression, performance}
...
% vspace command eliminates widow from end of page, avoiding 
% \newpage forces latex to make the bottoms match
\vspace{3pt}
