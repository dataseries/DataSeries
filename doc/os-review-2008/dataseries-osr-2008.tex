...
{\bf TODO: Use the right style file}
...
data that needs to be maintained archivally. To protect against media
errors or incorrect software systems, data should be capable of being
integrity checked.
...
Each extents consists of a header, followed by the fixed
...
{\bf TODO: to tease out the design decisions that lead to performance
improvement I added this section.  Perhaps the issues presented here
could go further forward in the paper.}

{\bf TODO: several of these are discussed. Need to double-check and
add applicablility to other uses (e.g. cast trickery applicable to
