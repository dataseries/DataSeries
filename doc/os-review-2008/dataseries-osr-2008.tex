...
and trailer at the end of the file. The header on a DataSeries file contains the DataSeries
...
from our comparison with Ellard.  More complete coverage can be found in the DataSeries technical report~\cite{DSTechnicalReportSnapshot}.
